...
La branche `main` contient désormais le template à la racine. L’ancienne application Laravel est conservée sur `archive/laravel-before-template-2026-09-11`.

Voir [DEPLOY-HOSTINGER.md](DEPLOY-HOSTINGER.md) pour publier sur `app.lesbambinos.sn` dans `public_html/app`.
