        ...
        <div class="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            <div class="animate-on-scroll text-center lg:text-left">
                ...
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-gray-900 leading-tight mb-4 sm:mb-6">
                    Un monde de <span class="text-primary-800">découvertes</span> pour votre enfant
                </h1>
                <p class="text-base sm:text-lg text-gray-600 font-body mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0">
                    Dans un environnement chaleureux et bienveillant, nous accompagnons chaque enfant dans son épanouissement et ses premiers apprentissages, de la garderie au CM2.
                </p>
            ...
            <div class="relative flex justify-center animate-on-scroll">
                <div class="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[480px] lg:h-[480px] max-w-full">
                    ...
                    <div class="absolute inset-0 overflow-hidden shadow-2xl" style="border-radius: 58% 42% 62% 38% / 45% 55% 45% 55%;">
                        <img src="{{ asset('images/72276.jpg') }}" alt="Élève souriante avec livres" class="w-full h-full object-cover">
                    </div>
                    {{-- Decorative rings --}}
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-5 lg:py-6">
            <div class="grid grid-cols-3 gap-3 sm:gap-6 lg:gap-8 text-center animate-on-scroll">
                <div>
                    ...
                    <span class="text-xs sm:text-sm md:text-base text-gray-600 font-body">Élèves</span>
                </div>
                <div>
                    <span class="block text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-primary-800" data-counter="15">15+</span>
                    <span class="text-xs sm:text-sm md:text-base text-gray-600 font-body">Ans d'expérience</span>
                </div>
                <div>
                    <span class="block text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-primary-800" data-counter="20">20+</span>
                    <span class="text-xs sm:text-sm md:text-base text-gray-600 font-body">Enseignants qualifiés</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center animate-on-scroll">
            ...
            <div class="relative">
                ...
                <div class="absolute top-20 right-0 z-20 w-3/5 rounded-3xl overflow-hidden shadow-xl border-4 border-pink-200">
                    <img src="{{ asset('images/7.jpg') }}" alt="Élève souriant en classe" class="w-full h-64 object-cover">
                </div>
                {{-- Decorative accent --}}
            ...
            {{-- Right: Welcome text --}}
            <div>
                <span class="inline-block bg-pink-100 text-primary-800 font-heading font-semibold text-sm px-4 py-2 rounded-full mb-4">À propos de nous</span>
                <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6">
                    Bienvenue au <span class="text-primary-800">Groupe Scolaire Mère Thérèsa</span>
                </h2>
                <p class="text-gray-600 font-body mb-6 leading-relaxed">
                    Situé au cœur de Guédiawaye, notre établissement offre un cadre d'apprentissage stimulant et sécurisé pour les enfants de 2 ans a 11 ans. Notre mission est de favoriser l'épanouissement global de chaque enfant à travers une pédagogie bienveillante et adaptée.
                </p>
                <p class="text-gray-600 font-body mb-8 leading-relaxed">
                    Depuis plus de 15 ans, nous accompagnons les familles de la region dans l'éducation de leurs enfants, en alliant excellence academique et développement personnel.
                </p>
                ...
                <div class="grid sm:grid-cols-2 gap-4 mb-8">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-body font-semibold text-gray-700">Suivi personnalisé</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                        </div>
                        <span class="font-body font-semibold text-gray-700">Environnement sécurisé</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/></svg>
                        </div>
                        <span class="font-body font-semibold text-gray-700">Activites variées</span>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-6 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 font-body">Groupe Scolaire Mère Thérèsa</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">
                Un parcours adapté a <span class="text-primary-800">chaque age</span>
            </h2>
            <p class="text-gray-600 font-body max-w-2xl mx-auto">
                De la garde des tout-petits au CM2, nous proposons des programmes pédagogiques adaptes a chaque étape du développement de votre enfant.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-on-scroll">
            ...
            <div class="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
                ...
                <div class="p-8">
                    ...
                    <p class="text-gray-600 font-body mb-6">Éveil et garde sécurisée dans un espace chaleureux adapté aux tout-petits. Activites sensorielles et premières découvertes.</p>
            ...
            <div class="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
                ...
                <div class="p-8">
                    ...
                    <p class="text-gray-600 font-body mb-6">Premiers apprentissages à travers le jeu et la creativite. Developpement du langage et de la motricite fine.</p>
            ...
            <div class="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
                ...
                <div class="p-8">
                    ...
                    <p class="text-gray-600 font-body mb-6">Apprentissages fondamentaux : lecture, ecriture, mathematiques. Construction de bases solides pour la réussite scolaire.</p>
...
<section class="py-20 bg-cream">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <p class="text-gray-600 font-body max-w-2xl mx-auto">
                Nous mettons tout en œuvre pour offrir a chaque enfant les meilleures conditions d'apprentissage et d'épanouissement.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-on-scroll">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center">
                ...
                <h3 class="text-lg font-heading font-bold text-gray-900 mb-3">Enseignants qualifiés et passionnes</h3>
                <p class="text-gray-600 font-body">Une équipe pédagogique experimentee, dédiée a l'accompagnement et a la réussite de chaque élève.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center">
                ...
                <h3 class="text-lg font-heading font-bold text-gray-900 mb-3">Environnement sécurisé</h3>
                <p class="text-gray-600 font-body">Un cadre sécurisé et surveille où chaque enfant evolue en toute serenite tout au long de la journée.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center">
                ...
                <h3 class="text-lg font-heading font-bold text-gray-900 mb-3">Suivi personnalisé de chaque enfant</h3>
                <p class="text-gray-600 font-body">Des effectifs maitrise permettant un accompagnement individuel et un suivi regulier des progres de chaque élève.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center">
                ...
                <h3 class="text-lg font-heading font-bold text-gray-900 mb-3">Activites extra-scolaires variées</h3>
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">
                Notre <span class="text-primary-800">Équipe Pédagogique</span>
            </h2>
            <p class="text-gray-600 font-body max-w-2xl mx-auto">
                Des professionnels passionnes et experimentes, devoues au développement et a la réussite de vos enfants.
            </p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 animate-on-scroll">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center group">
                ...
                <p class="text-gray-600 font-body text-sm">Plus de 20 ans d'expérience dans l'éducation. Passionnee par la pédagogie bienveillante et le développement de l'enfant.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center group">
                ...
                <p class="text-gray-600 font-body text-sm">Specialiste de la petite enfance, elle créé un environnement stimulant et securisant pour les plus jeunes.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center group">
                ...
                <p class="text-gray-600 font-body text-sm">Enseignant dédié avec une approche pédagogique innovante qui motive les élèves a donner le meilleur d'eux-memes.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 text-center group">
                ...
                <p class="text-gray-600 font-body text-sm">Specialisee en éveil des tout-petits, elle accompagne avec douceur et professionnalisme les premiers pas de chaque enfant.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-cream">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">
                La Vie a <span class="text-primary-800">l'École</span>
            </h2>
            <p class="text-gray-600 font-body max-w-2xl mx-auto">
                Découvrez en images le quotidien de nos élèves et les moments forts de notre école.
            </p>
        </div>
        ...
        <div class="columns-2 md:columns-3 gap-4 space-y-4 animate-on-scroll">
            <div class="break-inside-avoid rounded-3xl overflow-hidden shadow-md group cursor-pointer" data-lightbox="gallery">
                <div class="relative overflow-hidden">
                    <img src="{{ asset('images/7.jpg') }}" alt="Élève souriant en classe" class="w-full object-cover group-hover:scale-110 transition-transform duration-500">
...
<section class="py-20" style="background: linear-gradient(135deg, #EFF2FB 0%, #E8F4FD 100%);">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            <span class="inline-block bg-pink-100 text-pink-700 font-heading font-semibold text-sm px-4 py-2 rounded-full mb-4">Témoignages</span>
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">
                Ce que disent <span class="text-primary-800">les parents</span>
            </h2>
            <p class="text-gray-600 font-body max-w-2xl mx-auto">
                La confiance des familles est notre plus grande fierte. Découvrez leurs témoignages.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 animate-on-scroll">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 relative">
                ...
                <p class="text-gray-600 font-body mt-6 mb-6 leading-relaxed italic">
                    "Mon fils est inscrit a Mère Thérèsa depuis la Petite Section. L'équipe pédagogique est formidable et très attentive aux besoins de chaque enfant. Il a fait des progres incroyables et adore aller a l'école chaque matin !"
                </p>
                <div class="flex items-center gap-3 border-t border-gray-100 pt-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 font-body">Parent d'élève - CE1</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 relative">
                ...
                <p class="text-gray-600 font-body mt-6 mb-6 leading-relaxed italic">
                    "Ce qui nous a convaincus, c'est la qualite de l'encadrement et la proprete des locaux. Nos deux enfants y sont inscrits et nous sommes très satisfaits des resultats scolaires. La cantine est egalement un vrai plus !"
                </p>
                <div class="flex items-center gap-3 border-t border-gray-100 pt-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 font-body">Parent d'élèves - MS et CM1</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md hover:shadow-lg transition-all duration-300 relative">
                ...
                <p class="text-gray-600 font-body mt-6 mb-6 leading-relaxed italic">
                    "Ma fille etait très timide avant d'integrer Mère Thérèsa. Grâce à la bienveillance des educatrices, elle s'est épanouie et a pris confiance en elle. Je recommande cette école a tous les parents du quartier !"
                </p>
                <div class="flex items-center gap-3 border-t border-gray-100 pt-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 font-body">Parent d'élève - GS</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-20 bg-cream">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">
                Actualités & <span class="text-primary-800">Événements</span>
            </h2>
            <p class="text-gray-600 font-body max-w-2xl mx-auto">
                Restez informes de la vie de l'école, des événements a venir et des moments forts de l'année scolaire.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 animate-on-scroll">
            ...
            <div class="bg-white rounded-3xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group">
                <div class="relative overflow-hidden h-52">
                    <img src="{{ asset('images/25620.jpg') }}" alt="Rentrée scolaire" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                ...
                <div class="p-6">
                    <span class="inline-block bg-sky-100 text-sky-700 text-xs font-semibold px-3 py-1 rounded-full mb-3">Rentrée</span>
                    <h3 class="text-lg font-heading font-bold text-gray-900 mb-2 group-hover:text-primary-800 transition-colors">Rentrée scolaire 2025-2026</h3>
                    <p class="text-gray-600 font-body text-sm mb-4">La rentrée scolaire approche ! Découvrez les dates importantes, les fournitures necessaires et les nouveautes de cette année.</p>
            ...
            <div class="bg-white rounded-3xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group">
                <div class="relative overflow-hidden h-52">
                    <img src="{{ asset('images/8845.jpg') }}" alt="Journée portes ouvertes" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="absolute top-4 left-4 bg-white rounded-xl px-3 py-1.5 shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 font-body text-sm mb-4">Venez découvrir notre école lors de notre journée portes ouvertes. Visitez nos locaux, rencontrez les enseignants et inscrivez vos enfants.</p>
                    <a href="{{ route('news') }}" class="inline-flex items-center text-primary-800 font-heading font-semibold text-sm hover:text-pink-700 transition-colors">
                        Lire la suite
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
            ...
            <div class="bg-white rounded-3xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group">
                <div class="relative overflow-hidden h-52">
                    <img src="{{ asset('images/275099.jpg') }}" alt="Fete de fin d'année" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="absolute top-4 left-4 bg-white rounded-xl px-3 py-1.5 shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-heading font-bold text-gray-900 mb-2 group-hover:text-primary-800 transition-colors">Fete de Fin d'Année</h3>
                    <p class="text-gray-600 font-body text-sm mb-4">Rejoignez-nous pour celebrer la fin de l'année scolaire avec spectacles, remise de prix et activites festives pour toute la famille.</p>
                    <a href="{{ route('news') }}" class="inline-flex items-center text-primary-800 font-heading font-semibold text-sm hover:text-pink-700 transition-colors">
                        Lire la suite
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
...
<section class="py-16 bg-primary-800 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 animate-on-scroll">
        ...
        <p class="text-white/80 font-body max-w-2xl mx-auto mb-8 text-lg">
            Les inscriptions sont ouvertes pour l'année scolaire 2026-2027. Offrez a votre enfant un cadre d'apprentissage exceptionnel.
        </p>
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-md flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 font-body text-sm">SHS N&deg; 60 Golf Nord, Guédiawaye</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-md flex items-start gap-4">
                        ...
                        <div>
                            <h4 class="font-heading font-bold text-gray-900 text-sm mb-1">Téléphone</h4>
